    ...
    <div dir="rtl" className="">
      <Accordion type="single" collapsible>
        <AccordionItem key={data.id} value={data.id}>
          <AccordionTrigger
            className={`bg-blueSky text-white font-semibold md:font-normal hover:no-underline flex flex-col text-sm sm:text-lg sm:flex-row p-2 border-2 hover:border-blue-300 ${
