    ...
    <div dir="rtl">
      <Accordion type="single" collapsible>
        <AccordionItem key={data.id} value={data.id} className="group">
          <AccordionTrigger
            className={`flex flex-col sm:flex-row bg-customGreen1 text-sm sm:text-lg text-white md:font-normal font-semibold p-2 sm:p-3 hover:no-underline border-2 hover:border-green-300 ${
